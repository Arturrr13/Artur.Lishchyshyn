...
// }
function task1() {
  var age = parseInt(document.getElementById('task_1_number').value);
  var i = age;
...
function task3() {
  var start = parseInt(document.getElementById('task_3_number--1').value);
  var finish = parseInt(document.getElementById('task_3_number--2').value);
  var i = start;
  var rez = 0;
...
function task4() {
  var num1 = parseInt(document.getElementById('task_4_number--1').value);
  var num2 = parseInt(document.getElementById('task_4_number--2').value);
...
function task5() {
  var num = parseInt(document.getElementById('task_5_number').value);
  var rez = '';
  var i = 1;
...
function task6() {
  ...
  var lastcenter = parseInt(num % 100 / 10);
  var firstcenter = parseInt(num / 1000 - first * 10);
  var i = 1;
...
function task7() {
  var num = parseInt(document.getElementById('task_7_number').value);
  var i = 199;
...
function task8() {
  ...
  rez = "\u0414\u043E\u0434\u0430\u0442\u043D\u0456: ".concat(pl, ", \u0412\u0456\u0434'\u0454\u043C\u043D\u0456: ").concat(mn, ", \u041F\u0430\u0440\u043D\u0456: ").concat(pr, ", \u041D\u0435\u043F\u0430\u0440\u043D\u0456: ").concat(npr, ", \u041D\u0443\u043B\u0456: ").concat(zer);
...
function task12() {
  var d = parseInt(prompt('Введіть день'));
  var m = parseInt(prompt('Введіть місяць'));
  var y = parseInt(prompt('Введіть рік'));
  var i = 0,
      rez = '';
